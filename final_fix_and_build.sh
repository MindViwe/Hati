...
echo "--- Starting Final Automated Fix and Build Script ---"
...
# Replace any existing version with 8.7.3, a good compromise version
sed -i 's/com.android.tools.build:gradle:.*\([0-9]\+\.[0-9]\+\.[0-9]\+\)/com.android.tools.build:gradle:8.7.3/g' "$PROJECT_BUILD_GRADLE"
echo "  -> Set AGP to version 8.7.3."
